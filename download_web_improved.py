#!/usr/bin/env python3
"""
Download Complete World English Bible (WEB)
Modern English translation in the public domain
"""
...
print("=" * 70)
print()
print("The World English Bible is a modern English translation")
print("in the public domain. It's easier to read than KJV!")
print()

# Create bible_data directory
os.makedirs('bible_data', exist_ok=True)

# GetBible API URL for complete WEB
url = "https://api.getbible.net/v2/web.json"

print("Step 1: Downloading WEB Bible...")
print(f"Source: {url}")
print()
...
try:
    ...
    print(f"Year: 2020 (completed)")
    print(f"Style: Modern English, public domain")
    ...
    if len(converted_books) == 66:
        ...
        print()
        print("The WEB uses modern, readable English similar to ESV/NIV.")
        print()
        ...
        print()
        print("Example verse (John 3:16 in WEB):")
        print("'For God so loved the world, that he gave his only born Son,")
        print(" that whoever believes in him should not perish, but have eternal life.'")
        print()
    else:
